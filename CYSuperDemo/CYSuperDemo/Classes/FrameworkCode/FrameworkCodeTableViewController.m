...
{
    if (!_titleArr) {
        _titleArr = @[@"Foundation", @"UIKit", @"Accounts", @"AddressBook", @"ARKit", @"AudioToolbox", @"AuthenticationServices", @"AVFoundation", @"AVKit", @"BusinessChat", @"CallKit", @"CarPlay", @"CloudKit", @"Contacts", @"CoreAudioKit", @"CoreBluetooth", @"CoreML", @"CoreMotion", @"CoreNFC", @"CoreTelephony", @"CoreText", @"CoreVideo", @"DeviceCheck", @"EventKit", @"HealthKit", @"IAD", @"LocalAuthentication", @"MapKit", @"MediaPlayer", @"Network", @"PassKit", @"PDFKit", @"PushKit", @"QuickLook", @"ReplayKit", @"SafariServices", @"Speech", @"StoreKit", @"UserNotifications"];
    }
    return _titleArr;
}
