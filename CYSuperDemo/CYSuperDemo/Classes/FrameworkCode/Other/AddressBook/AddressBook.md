...
​    在AddressBook框架中，两个最重要的数据模型为ABAddressbookRef与ABRecordRef。前者我们可以理解为通讯录的抽象对象，用它来具体操作通讯录的行为，后者可以理解为通讯录中记录的抽象对象，其中封装了联系人的相关信息。
...
![img](https://oscimg.oschina.net/oscnet/071948438daf8eaff82d4b774e2900e90de.jpg)
...
![img](https://oscimg.oschina.net/oscnet/b2410a93c1ff384b007f91c725de5cb289f.jpg)
